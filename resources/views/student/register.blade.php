...
<body>
	...
	<div class="container-login100" style="background-image: url('login/images/bg-01.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="{{url('logins')}}">
				{{csrf_field()}}
				...
				<div class="wrap-input100 validate-input m-b-25" data-validate = "firstname">
					<input class="input100" type="text" name="First_name" placeholder="Enter Firstname" requiredx	>
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="mobile">
					<input class="input100" type="number" name="Mobile_No" placeholder="Mobile no" >
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" data-validate = "password">
					<input class="input100" type="password" minlength="6" maxlength="12" name="Password" placeholder="Enter password">
					<span class="focus-input100"></span>
				</div>


				<div class="wrap-input100 validate-input m-b-25" data-validate = "password">
					<input class="input100" type="file" name="image" placeholder="Enter password">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="text-center p-t-57 p-b-20">
					<span class="txt1" href="">
						Already sign in <a href="/logins">  Login   </a> 
					</span>
				</div>
